...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const sponsorTotal = sponsorCoins.data
      .reduce((sum, c) => sum + BigInt(c.balance), BigInt(0));
    console.log('[drip] Sponsor address:', sponsorAddr);
    console.log('[drip] Sponsor total balance (mist):', sponsorTotal.toString());
